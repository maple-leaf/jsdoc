...
var DIRECTIVE_NAMESPACE = 'directive';

var files = {};
var ids = {};

// each container gets its own html file
var containers = ['class', 'module', 'external', 'namespace', 'mixin', 'interface', 'component', 'directive'];
...
function isModuleExports(doclet) {
    ...
    (
        ...
        doclet.longname.indexOf(COMPONENT_NAMESPACE) === 0 && doclet.kind !== 'component' ||
        doclet.longname.indexOf(DIRECTIVE_NAMESPACE) === 0 && doclet.kind !== 'directive'
    );
}
